var localEle=localStorage.getItem('key');
...
function mainFunction(){
  ...
  var innerhead=document.createElement('h3');
  var innerDescrip=document.createElement("p");
  var itallic=document.createElement("i");
  ...
  var flexImg=document.createElement('img');
  var flexImg1=document.createElement('img');
  ...
  var valueTitle=document.getElementById("recipient-name").value;
  var valueDescrip=document.getElementById("message-text").value;
  var colorPicker=document.getElementById("recipient-name1").value;
  var dateSelector=document.getElementById("recipient-name2").value;
  ...
  forDate.innerHTML="Added : " + dateSelector;
...
function editButton(Id1, Id2, Id3) {
  var savedTitle = document.getElementById(Id1).innerHTML;
  var inputValue = document.getElementById('recipient-name').value = savedTitle;
  document.getElementById(Id1).innerHTML = inputValue;
  //document.getElementById('add').style.display="none";
  var savedDescrip = document.getElementById(Id2).innerHTML;
  var inputValue1 = document.getElementById('message-text').value = savedDescrip;
  document.getElementById(Id2).innerHTML = inputValue1;

  var dateSetting = document.getElementById(Id3).innerHTML;
  var inputValue2 = document.getElementById('recipient-name2').value = dateSetting;
...
function funcUpdate() {
  ...
  var updated=document.getElementById('recipient-name').value;
  document.getElementById(a).innerHTML=updated;
  var upda=document.getElementById(b).innerHTML;
  var updated=document.getElementById('message-text').value;
  document.getElementById(b).innerHTML=updated;
  var upda=document.getElementById(c).innerHTML;
  var updated=document.getElementById('recipient-name2').value;
  document.getElementById(c).innerHTML=updated;
  ...
  for(let i=0;i<localEle2.length;i++){
    ...
    forDate.innerHTML="Added : " + localEle2[i].Dated;
